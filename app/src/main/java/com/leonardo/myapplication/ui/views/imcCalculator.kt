package com.leonardo.myapplication.ui.views
...
fun ImcCalculator(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        var pesoIput by remember { mutableStateOf("") }
        ...
        OutlinedTextField(
            value = pesoIput,
            onValueChange = {
                pesoIput = it.filter { char -> char.isDigit() || char == '.' }
            },
            label = {
                Text(text = "Peso")
            },
        ...
        Button(
            onClick = {
                val peso = pesoIput.toDoubleOrNull()
                ...
                if (peso != null && altura != null && peso > 0 && altura > 0) {
                    ...
                    imcResult = null
                    resultadoTexto = "Por favor digite um valor válido"
                }
